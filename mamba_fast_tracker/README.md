...
Este projeto utiliza o **Flutter  na versão 3.38.5** para garantir consistência na versão do Flutter.
...
##  Adicionais:
  ...
  -  tema light mode e dark mode.  
  - Só para inicialização e finalização do jejum depois da hora solicitada de jejum.
